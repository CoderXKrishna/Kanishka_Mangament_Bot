...
if ENV:
    ...
    from KanishkaBot.config import Development as Config
...
telethn = TelegramClient("Kanishka", API_ID, API_HASH)

pbot = Client("KanishkaBot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from KanishkaBot.modules.helper_funcs.handlers import (
