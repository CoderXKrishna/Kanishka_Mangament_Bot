...
def totranslate(update: Update, context: CallbackContext) -> None:
    ...
    if not reply_msg:
        message.reply_text(
            ...
            "ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ sᴇᴇ [ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ʟᴀɴɢᴜᴀɢᴇ ᴄᴏᴅᴇs](https://t.me/Kanishkabotzone/16).",
            parse_mode="markdown",
...
from KanishkaRobot import OWNER_ID, dispatcher
from KanishkaRobot import pbot as client

Kanishka = "https://te.legra.ph/file/1a72f3770dcb90ee8b3f7.jpg"
