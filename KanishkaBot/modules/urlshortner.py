...
@Kanishka.on_message(filters.command(["short"]))
...
@Kanishka.on_message(filters.command(["unshort"]))
...
# Kanishka.add_handler(MessageHandler(short_urls))
# Kanishka.add_handler(MessageHandler(unshort))
__help__ = """
