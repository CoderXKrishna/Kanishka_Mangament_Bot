...
from KanishkaBot.modules.helper_funcs.msg_types import Types
from KanishkaBot.modules.sql import BASE, SESSION

DEFAULT_WELCOME = "Hey {first}, Kaisa hai Babu?"
DEFAULT_GOODBYE = "Gya Ma Ka bharose wala!"
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined the chat -  walaasdgfhak!",
