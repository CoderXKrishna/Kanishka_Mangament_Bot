...
import KanishkaRobot.modules.fun_strings as fun_strings
from KanishkaRobot import dispatcher,OWNER_ID
...
def slap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.SLAP_Kanishka_TEMPLATES)
