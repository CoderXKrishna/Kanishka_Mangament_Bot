...
import KanishkaRobot
import KanishkaRobot.modules.sql.welcome_sql as sql
...
from KanishkaRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from KanishkaRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from KanishkaRobot.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not KanishkaRobot.ALLOW_CHATS:
