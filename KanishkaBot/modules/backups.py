...
# from KanishkaRobot.modules.sql import warns_sql as warnssql
import KanishkaRobot.modules.sql.blacklist_sql as blacklistsql

# from KanishkaRobot.modules.sql import cust_filters_sql as filtersql
# import KanishkaRobot.modules.sql.welcome_sql as welcsql
import KanishkaRobot.modules.sql.locks_sql as locksql
import KanishkaRobot.modules.sql.notes_sql as sql

# from KanishkaRobot.modules.rules import get_rules
import KanishkaRobot.modules.sql.rules_sql as rulessql
from KanishkaRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from KanishkaRobot.__main__ import DATA_IMPORT
from KanishkaRobot.modules.connection import connected
from KanishkaRobot.modules.helper_funcs.alternate import typing_action
from KanishkaRobot.modules.helper_funcs.chat_status import user_admin
from KanishkaRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("KanishkaRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KanishkaRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KanishkaRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KanishkaRobot{}.backup".format(chat_id))  # Cleaning file
