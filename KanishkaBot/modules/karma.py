...
from KanishkaRobot import OWNER_ID, pbot
from KanishkaRobot.utils.admins import can_change_info
from KanishkaRobot.utils.errors import capture_err
from KanishkaRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|Kanishka|thank you|gud|thankyou|love|pro)$"
