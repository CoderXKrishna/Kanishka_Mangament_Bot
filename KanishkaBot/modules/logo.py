...
from KanishkaRobot.modules.nightmode import button_row
from KanishkaRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./KanishkaRobot/resources/fonts/*")
