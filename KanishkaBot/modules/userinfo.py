...
from KanishkaRobot.modules.alive import Kanishka
import KanishkaRobot.modules.sql.userinfo_sql as sql
from KanishkaRobot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
    INFOPIC,
...
from KanishkaRobot.__main__ import STATS, TOKEN, USER_INFO
from KanishkaRobot.modules.disable import DisableAbleCommandHandler
from KanishkaRobot.modules.helper_funcs.chat_status import sudo_plus
from KanishkaRobot.modules.helper_funcs.extraction import extract_user
from KanishkaRobot.modules.sql.global_bans_sql import is_user_gbanned
from KanishkaRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Kanishkabotzone/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/Kanishkabotzone/90"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/Kanishkabotzone/26"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/Kanishkabotzone/90"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/Kanishkabotzone/26"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
