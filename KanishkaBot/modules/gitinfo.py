...
from KanishkaRobot import pbot
...
**ғᴏʟʟᴏᴡɪɴɢ :** `{following}`"""
    ...
    await message.reply_photo(photo=avatar_url, caption=caption,reply_markup=InlineKeyboardMarkup(Kanishka))
