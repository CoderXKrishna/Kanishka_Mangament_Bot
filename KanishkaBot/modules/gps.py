...
import asyncio
from KanishkaRobot import pbot as Kanishka
from pyrogram.handlers import MessageHandler
from geopy.geocoders import Nominatim
from geopy.distance import great_circle
@Kanishka.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        ---------github :-CoderXKrishna -----
        ---------telegram : @Itsz_Krish_Babess-----
        """
        geolocator = Nominatim(user_agent="Krishna-Kanishka")
#         zoom=[0-18]
...
@Kanishka.on_message(filters.command(["distance"]))
...
# Kanishka.add_handler(MessageHandler(gps))     
# Kanishka.add_handler(MessageHandler(distance))
