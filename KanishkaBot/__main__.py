...
import KanishkaBot.modules.no_sql.users_db as sql
from KanishkaBot import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
    OWNER_ID,
...
from KanishkaBot.modules import ALL_MODULES
from KanishkaBot.modules.helper_funcs.chat_status import is_user_admin
from KanishkaBot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text="🏡", callback_data="Kanishka_back"),
        InlineKeyboardButton(text="🛡️", callback_data="Kanishka_"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KanishkaBot.modules." + module_name)
        ...
        if mod_match:
            ...
            query.message.edit_caption(text,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="Kanishka_support")]]
                ),
            )
...
def Kanishka_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "Kanishka_":
        uptime = get_readable_time((time.time() - StartTime))
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="🚩sᴜᴩᴩᴏʀᴛ", callback_data="Kanishka_support"
                        ),
                        InlineKeyboardButton(
    ...
    elif query.data == "Kanishka_support":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="Kanishka_"),
                    ],
                ]
            ),
        )
    elif query.data == "Kanishka_back":
        first_name = update.effective_user.first_name 
...
def KanishkaBot_Main_Callback(update: Update, context: CallbackContext):
    query = update.callback_query
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="• Hᴏᴍᴇ •", callback_data="Kanishka_back")]
                ]
            ),
        )
...
◽️ /staff ɢɪᴠᴇs ᴛʜᴇ ᴄᴏᴍᴘʟᴇᴛᴇ Lɪsᴛ ᴏғ ɢʀᴏᴜᴘ Sᴛᴀғғ!.""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Main_help"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="Kanishka_support")
                    ]
                ]
            ),
            )
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/Kanishkabotzone/7"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="Kanishka_support")
                    ]
                ]
            ),
            )  
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" ʙᴀᴄᴋ ", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="Kanishka_support")
                    ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="Kanishka_support")]]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5935608297:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/noob-Kanishka/KanishkaBot)"
...
""",reply_markup=x,
    ...
    about_callback_handler = CallbackQueryHandler(
        Kanishka_about_callback, pattern=r"Kanishka_", run_async=True
    )
    ...
    KanishkaBot_main_handler = CallbackQueryHandler(
        KanishkaBot_Main_Callback, pattern=r".*_help",run_async=True)
    ...
    dispatcher.add_handler(KanishkaBot_main_handler)
